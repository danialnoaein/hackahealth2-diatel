...
class SliderViewController: UIViewController,UIScrollViewDelegate {
    ...
    func createslide() -> [SlideItem]{
        ...
        slide1.imageContainer.image = #imageLiteral(resourceName: "cheap-s1")
        ...
        slide2.imageContainer.image = #imageLiteral(resourceName: "cheap-s2")
        ...
        slide3.imageContainer.image = #imageLiteral(resourceName: "cheap-s6")
        ...
        slide4.imageContainer.image = #imageLiteral(resourceName: "cheap-s2")
        ...
        slide5.imageContainer.image = #imageLiteral(resourceName: "cheap-s4")
        ...
        slide6.imageContainer.image =  #imageLiteral(resourceName: "cheap-s3")
        ...
        let slide7:SlideItem = Bundle.main.loadNibNamed("SlideItem", owner: self, options: nil)?.first as! SlideItem;
         slide7.imageContainer.image =  #imageLiteral(resourceName: "cheap-s6")
        ...
        slide8.imageContainer.image = #imageLiteral(resourceName: "cheap-s1")
